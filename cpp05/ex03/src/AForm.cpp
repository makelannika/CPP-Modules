...
/*   Updated: 2024/11/07 23:08:24 by amakela          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
AForm::AForm(std::string name, std::string target, unsigned int toSign, unsigned int toExec) : name(name), target(target), gradeToSign(toSign), gradeToExec(toExec) {
	if (toSign < 1)
